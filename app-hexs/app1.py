...
def filter_points(points, kernel_size=3):
    ...
    # Obliczamy proporcje obrazu, maksymalna liczba pikseli w jednym wymiarze np. 500
    # Możesz też ustawić dynamicznie, np. width = int(lng_range * 1000), height = int(lat_range * 1000)
    width = 500
